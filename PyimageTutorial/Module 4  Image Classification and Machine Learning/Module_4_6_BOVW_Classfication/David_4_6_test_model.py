...
# (Set your own Path with image)python David_4_6_test_model.py --images "../../data/test_data" --codebook "../../../../CV_PyimageSearch_Local/Module_Code/Module 4/bovw_classification/output/vocab.cpickle" --model "../../../../CV_PyimageSearch_Local/Module_Code/Module 4/bovw_classification/output/model.cpickle"
